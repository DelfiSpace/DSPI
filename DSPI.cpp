...
{	
	...
	else
	{
		...
		SlaveConfig.spiMode					= EUSCI_B_SPI_4PIN_UCxSTE_ACTIVE_HIGH;                       // 4Wire SPI Mode with active high, macro found in spi.h	
		
		SPI_initSlave(this->module, &SlaveConfig);	//function found in spi.c
	}
